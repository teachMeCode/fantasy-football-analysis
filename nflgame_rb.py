...
#             writer.writerow([p, "%d" % (week_str), p.team, p.home, p.rushing_att, p.rushing_lng, p.rushing_lngtd, p.rushing_tds, p.rushing_twopa, p.rushing_twoptm, p.rushing_twoptmissed, p.rushing_yds])
# week_str +=1        
